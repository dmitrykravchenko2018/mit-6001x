...
class MITCampus(Campus):
    ...
    def add_tent(self, new_tent_loc):
        ...
        # Your code here
        assert(isinstance(new_tent_loc, Location)), 'new_tent_loc is not a Location object'
        for tent in self.tents_list:
    ...
    def remove_tent(self, tent_loc):
        ...
        # Your code here
        assert(isinstance(tent_loc, Location )), 'tent_loc is not a Location object'
        if tent_loc in self.tents_list:
        	self.tents_list.remove(tent_loc)
        else:
    ...
    def get_tents(self):
        ...
        # Your code here
        l = []
        self.tents_list.sort(key = lambda tent: tent.x)
        for tent in self.tents_list:
        	l.append(tent.__str__())
        return l
